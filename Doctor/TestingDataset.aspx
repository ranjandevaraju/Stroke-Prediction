<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/Doctor.Master" AutoEventWireup="true" CodeBehind="TestingDataset.aspx.cs" Inherits="diseasePrediction.Doctor.TestingDataset" %>
...
<asp:Panel ID="panelAdminHome" runat="server">
 <div class="article">
			<h2>Testing Dataset (New Patients)!!!</h2>
    <br />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" 
                                ControlToValidate="txtHD" ErrorMessage="Only Numbers" Font-Size="X-Small" 
                                ForeColor="Red" ToolTip="Only Numbers" 
                                ValidationExpression="^[+-]?([0-9]+([.][0-9]*)?|[.][0-9]+)$" 
                                ValidationGroup="user"></asp:RegularExpressionValidator>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator13" 
                                runat="server" ControlToValidate="txtavgglucoselevel" 
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator15" 
                                runat="server" ControlToValidate="txtsmokingstatus" ErrorMessage="Only Numbers" 
                                Font-Size="X-Small" ForeColor="Red" ToolTip="Only Numbers" 
                                ValidationExpression="^[+-]?([0-9]+([.][0-9]*)?|[.][0-9]+)$" 
                                ValidationGroup="user"></asp:RegularExpressionValidator>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator17" 
                                runat="server" ControlToValidate="txtdiabetes" ErrorMessage="Only Numbers" 
                                Font-Size="X-Small" ForeColor="Red" ToolTip="Only Numbers" 
                                ValidationExpression="^[+-]?([0-9]+([.][0-9]*)?|[.][0-9]+)$" 
                                ValidationGroup="user"></asp:RegularExpressionValidator>
                        </td>
